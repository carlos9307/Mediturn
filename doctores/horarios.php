							...
							<div class="col-xs-12">
								...
								<div class="widget-body">
										...
										<table class="table  table-bordered table-hover">
											<thead>
											    <tr>
											      ...
											      <th  class="center scope="col">Medico</th>
											      <th  class="center scope="col">Dia</th>
											      <th  class="center scope="col">Desde</th>
											      <th  class="center scope="col">Hasta</th>
									...
									<div class="pull-right">
										...
										<a href="horarios-agregar.php" class="btn btn-sm btn-primary"> <i class="ace-icon glyphicon glyphicon-plus"></i>Agregar</a>
